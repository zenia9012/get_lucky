        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('home', ['auth_link' => Auth::user()->auth_link ])" :active="request()->routeIs('home')">
                        {{ __('Dashboard', ) }}
                    </x-nav-link>
                </div>
                @if(Auth::user()->is_admin)
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-nav-link :href="route('admin.users.index', ['auth_link' => Auth::user()->auth_link ])" :active="request()->routeIs('home')">
                            {{ __('Admin' ) }}
                        </x-nav-link>
                    </div>
                @endif
